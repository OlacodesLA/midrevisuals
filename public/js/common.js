/**
 *	Midre Visuals - Creative Portfolio Agency HTML Template
 *	Version: 1.0
 *	Author: bslthemes
 *	Author URL: http://themeforest.net/user/bslthemes
 *	Copyright © Midre Visuals by bslthemes. All Rights Reserved.
 **/
...
(function ($) {
  ...
  $(".onovo-menu-btn").on("click", function () {
    ...
    if (obj.hasClass("btn--active")) {
      ...
      setTimeout(function () {
        ...
        obj
          .parent()
          .find(".onovo-menu-container")
          .removeClass("onovo--noscroll");
  ...
  $(".js-hero-parallax").each(function () {
    ...
    heroParallax.pagepiling({
      ...
      afterRender: function () {
        if (
          heroParallax
            .find(".onovo-hero-parallax-section.active")
  ...
  $(".js-hero-slider").each(function () {
    ...
    if (heroMainSwiper_auto_val > 1) {
      ...
      heroMainSwiper
        .find(".swiper-slide")
        .attr("data-swiper-autoplay", heroMainSwiper_auto_val);
    } else {
    ...
    heroMainSwiper
      .find(".onovo-paginations-container")
  ...
  $(".js-hero-carousel").each(function () {
    ...
    if (heroSwiper_auto_val > 1) {
      ...
      heroSwiper
        .find(".swiper-slide")
        .attr("data-swiper-autoplay", heroSwiper_auto_val);
    } else {
  ...
  $(".js-blog-carousel").each(function () {
    ...
    if (blogSwiper_auto_val > 1) {
      ...
      blogSwiper
        .find(".swiper-slide")
        .attr("data-swiper-autoplay", blogSwiper_auto_val);
    } else {
  ...
  $(".js-reviews-carousel").each(function () {
    ...
    if (reviewSwiper_auto_val > 1) {
      ...
      reviewSwiper
        .find(".swiper-slide")
        .attr("data-swiper-autoplay", reviewSwiper_auto_val);
    } else {
  ...
  $(".js-history-slider").each(function () {
    ...
    if (hisSwiper_auto_val > 1) {
      ...
      hisSwiper
        .find(".swiper-slide")
        .attr("data-swiper-autoplay", hisSwiper_auto_val);
    } else {
    ...
    hisSwiper
      ...
      .each(function () {
        ...
        var hisSwiper_date = hisSwiper
          .find(".swiper-slide:nth-child(" + hisSwiper_index + ") .subtitle")
          .text();
  ...
  $(".onovo-service-grid-item.active--default").each(function () {
    $(this)
      .closest(".onovo-services-grid-fw")
      .hover(
        function () {
          if (
            $(this).find(".onovo-service-grid-item").hasClass("active--default")
          ) {
        ...
        function () {
          if (
            ...
            $(this)
              .find(".onovo-service-grid-item.active--default")
              .addClass("active");
          }
        }
      );
  ...
  if ($(".onovo-showcase-items").length) {
    $(".onovo-showcase-items")
      .find(".onovo-showcase-item:first-child")
      .addClass("hover");
  }
  $(".onovo-showcase-item").mouseenter(function () {
    var obj = $(this);
    obj
      .closest(".onovo-showcase-items")
      .find(".onovo-showcase-item")
      .removeClass("hover");
    obj.addClass("hover");
  });
  ...
  $(".onovo-filter-nav-active").each(function () {
    $(this).css({
      width:
        $(this)
          .closest(".onovo-filter.filter--default")
          .find(".item--active")
          .parent()
          .width() +
        6 +
  ...
  $(".onovo-filter").on("click", "button", function () {
    ...
    var current_pos = $(this)
      .closest(".onovo-filter.filter--default")
      .find(".item--active")
      .parent()
      .position().left;
    var current_width = $(this)
      .closest(".onovo-filter.filter--default")
      .find(".item--active")
      .parent()
      .width();
    $(this)
      .closest(".onovo-filter.filter--default")
      .find(".onovo-filter-nav-active")
      .css({ width: current_width + 6 + "px" });
    $(this)
      .closest(".onovo-filter.filter--default")
      .find(".onovo-filter-nav-active")
      .css({ left: current_pos - 3 + "px" });
  });
