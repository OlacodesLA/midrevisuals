                  ...
                  <div className="widget">
                    ...
                    <ul className="wp-block-latest-posts__list wp-block-latest-posts">
                      <li>
                        ...
                        >
                          Usability Secrets to Create Interfaces
                        </Link>
                        <span className="wp-block-latest-posts__post-date">
                          March 25, 2023
                        </span>
                      </li>
                      <li>
                        ...
                        <Link
                          ...
                          href="/blog/play-to-your-strength-and-supercharge-your-business"
                        >
                          The Main Thing For The Web Designer
                        </Link>
                        <span className="wp-block-latest-posts__post-date">
                          March 18, 2023
                        </span>
                      ...
                      <li>
                        ...
                        <Link
                          ...
                          href="/blog/play-to-your-strength-and-supercharge-your-business"
                        >
                          How to Do Your First Business Project
                        </Link>
                        <span className="wp-block-latest-posts__post-date">
                          March 10, 2023
                        </span>
                    ...
                    <ol className="wp-block-latest-comments">
                      <li className="wp-block-latest-comments__comment">
                        ...
                        <Link
                          ...
                          href="/blog/play-to-your-strength-and-supercharge-your-business"
                        >
                          Strength to Strength within the Business Solutions
                        </Link>
                      </li>
                      <li className="wp-block-latest-comments__comment">
                        <span className="wp-block-latest-comments__comment-author">
